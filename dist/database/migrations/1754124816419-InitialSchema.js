...
exports.InitialSchema1754124816419 = void 0;
class InitialSchema1754124816419 {
    constructor() {
        this.name = 'InitialSchema1754124816419';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "time_slots" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "date" date NOT NULL, "startTime" TIME NOT NULL, "endTime" TIME NOT NULL, "isAvailable" boolean NOT NULL DEFAULT true, "doctorId" uuid NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_f87c73d8648c3f3f297adba3cb8" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "time_slots" ADD CONSTRAINT "FK_3a42cdbee95b6cf3577453046eb" FOREIGN KEY ("doctorId") REFERENCES "doctors"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
    async down(queryRunner) {
        await queryRunner.query(`ALTER TABLE "time_slots" DROP CONSTRAINT "FK_3a42cdbee95b6cf3577453046eb"`);
...
exports.InitialSchema1754124816419 = InitialSchema1754124816419;
//# sourceMappingURL=1754124816419-InitialSchema.js.map